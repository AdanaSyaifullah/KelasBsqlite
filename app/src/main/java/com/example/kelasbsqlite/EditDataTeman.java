        ...
        StringRequest stringReq = new StringRequest(Request.Method.POST, url_update, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (sukses == 1) {
                        Toast.makeText(EditDataTeman.this, "Sukses mengedit data", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(EditDataTeman.this, "gagal", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(EditDataTeman.this,"Gagal Edit data",Toast.LENGTH_SHORT).show();
            }
        })
        {
            @Override
